...
{
  public enum PathfindingAgentType
  {
    Humanoid = 1,
    TrollSize,
    HugeSize,
  ...
  /// <summary>
  /// This is an empty file for non unity builds.
  ///
  /// In unity runtime this will be used for pathfinding calls.
  /// </summary>

#if !UNITY_EDITOR
  public class ValheimPathfinding
  {
#else
  public class ValheimPathfinding : MonoBehaviour, IPathfindingShim
  {
    ...
    {
      return GetPath(from, to, path, (AgentType)agentType, requireFullPath, cleanup, havePath);
    }
