...
- Description: Enables the debug menu, for showing colliders or rotating the
  ship
- Default Value: true
...
- Description: Saves the user's fingers by allowing the ship to continue to
  climb or descend without needing to hold the button
- Default Value: true

### Only allow rudder speeds during flight

- Description: Flight allows for different rudder speeds, only use those and
  ignore sails
- Default Value: true
