...
- Description: Hull Floatation Collider Customization, set this value and it will always make the ship float at that offset
- Default Value: 0
...
- Description: Automatically moves the vehicle. The close to 0 the closer it will be to teleporting the vehicle above the ground. The higher the number the more lenient it is. Recommended to keep this number above 5
- Default Value: 10
