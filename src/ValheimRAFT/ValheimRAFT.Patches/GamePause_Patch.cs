...
public class GamePause_Patch
{
  ...
  public static IEnumerator SetPlayerOnBoat(ZDO zdo, Player player)
  {
    ...
    var playerOffsetHash = VehiclePieceController.GetDynamicParentOffset(player.m_nview);
  ...
  private static void PreventTimeFreezeOnShip()
  {
    ...
    var baseVehicleShip = Player.m_localPlayer?.GetComponentInParent<VehiclePieceController>();
