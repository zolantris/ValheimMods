...
public class Hud_Patch
{
  ...
  //   }
  // }
  private static bool UpdateShipHudForVehicleShip(VehicleShip controlledShip, Hud __instance,
    Player player, float dt)
  {
    var speedSetting = controlledShip.GetSpeedSetting();
  ...
  public static bool UpdateShipHud(Hud __instance, Player player, float dt)
  {
    ...
    var controlledVehicleShip = controlledShipObj as VehicleShip;
    var controlledShip = controlledShipObj as Ship;

    if (controlledVehicleShip != null)
    {
      UpdateShipHudForVehicleShip(controlledVehicleShip, __instance, player, dt);
      return false;
    }

    if (controlledShip == null) return false;
