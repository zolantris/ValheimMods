Shader "Lux Lit Particles/ Tess Bumped" {
	Properties {
		...
		[Header(Tessellation)] [Space(4)] [IntRange] _Tess ("Subdivisions", Range(1, 13)) = 3
		[LuxParticles_HelpDrawer] _HelpFlip ("Only use odd numbers like 3, 5, 7, ...", Float) = 0
		_TessRange ("MinDist (X) MaxDist (Y)", Vector) = (25,40,0,0)
...
#pragma target 3.0
	...
	Fallback "Lux Lit Particles/ Bumped Smoke"
}