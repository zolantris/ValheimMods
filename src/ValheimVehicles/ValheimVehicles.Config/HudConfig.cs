...
public class HudConfig : BepInExBaseConfig<HudConfig>
{
  ...
  {
    HudAnchorTextAboveAnchors = config.BindUnique(SectionKey,
    ...
    HudAnchorMessageTimer = config.BindUnique(SectionKey,
    ...
    HudAnchorTextSize = config.BindUnique(SectionKey,
