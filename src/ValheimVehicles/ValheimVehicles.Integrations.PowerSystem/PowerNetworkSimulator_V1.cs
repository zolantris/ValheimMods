...
{
  public static class PowerNetworkSimulator_V1
  {
    //   public static void Simulate(PowerSimulationData simData)
    //   {
    ...
    //   }
    //
    //   private static float ComputeConsumerDemand(PowerSimulationData simData, float deltaTime)
    //   {
    //     var total = 0f;
    ...
    //   }
    //
    //   private static float ComputeConduitDemand(PowerSimulationData simData)
    //   {
    //     var total = 0f;
    ...
    //   }
    //
    //   private static float ComputeStorageDemand(PowerSimulationData simData)
    //   {
    //     var total = 0f;
    //     foreach (var (storage, _) in simData.Storages)
    //     {
    //       total += Mathf.Max(0f, storage.MaxEnergy - storage.StoredEnergy);
    //     }
    //     return total;
    //   }
    //
    //   private static float SimulatePeekStorageDischarge(
    //     PowerSimulationData simData,
    //     float totalDemand,
    ...
    //   }
    //
    //   private static void SimulateConduitEitrRecharge(PowerSimulationData simData, ref float available)
    //   {
    ...
    //   }
    //
    //   private static void SimulateStorageRecharge(PowerSimulationData simData, ref float available)
    //   {
    //     foreach (var (storage, _) in simData.Storages)
    //     {
    ...
    //   }
    //
    //   private static void PersistSimState(PowerSimulationData simData, Dictionary<PowerStorageData, float> storageSnapshot, Dictionary<PowerSourceData, float> sourceSnapshot)
    //   {
    //     foreach (var (source, _) in simData.Sources)
    //     {
