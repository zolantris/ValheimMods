...
public class VehicleBaseController : MonoBehaviour, IVehicleBaseProperties
{
  ...
  public static readonly Dictionary<int, VehicleBaseController> VehicleInstances = new();
  ...
  private static void UpdateShipSounds(VehicleBaseController vehicleBaseController)
  {
    if (vehicleBaseController == null) return;
    if (vehicleBaseController.ShipEffects == null) return;
    vehicleBaseController.ShipEffects.m_inWaterSoundRoot.SetActive(VehicleGlobalConfig.EnableShipInWaterSounds.Value);
    vehicleBaseController.ShipEffects.m_wakeSoundRoot.SetActive(VehicleGlobalConfig.EnableShipWakeSounds.Value);
    vehicleBaseController.ShipEffects.m_sailSound.gameObject.SetActive(VehicleGlobalConfig.EnableShipSailSounds.Value);
  }
   ...
   */
  public static VehicleBaseController? InitWithoutStarterPiece(Transform obj)
  {
    ...
    try
    {
      ...
      return ship.GetComponent<VehicleBaseController>();
    }
    catch
    {
      CanInitHullPiece = true;
