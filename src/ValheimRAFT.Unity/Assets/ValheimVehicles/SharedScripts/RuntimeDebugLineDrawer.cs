   ...
   public class RuntimeDebugLineDrawer : SingletonBehaviour<RuntimeDebugLineDrawer>
    {
        ...
        public static Color TRed = new Color(1f, 0, 0, 0.75f);
        public static Color TGreen = new Color(0, 1, 0, 0.75f);
        public static Color TBlue = new Color(0, 0.5f, 1, 0.75f);
        public static Color TOrange = new Color(1, 0.5f, 0, 0.75f);
        public static Color TYellow = new Color(1, 1f, 0, 0.75f);
        ...
        public override void OnAwake()
        {
            if (_defaultMat == null)
            {
                if (DebugRayMaterial == null)
                {
                    ...
                    _defaultMat = new Material(shader) { color = Color.white,
