...
namespace ValheimVehicles.SharedScripts
{
  ...
  public class ConvexHullTestGenerator : MonoBehaviour
  {
    ...
    private void SetupVehicleProperties()
    {
      if (vehicleLandMovementController != null)
      {
        if (vehicleLandMovementController.wheelParent == null)
        {
          vehicleLandMovementController.wheelParent = transform.Find("vehicle_land/wheels");
        }

        vehicleLandMovementController.SetBrake(false);

        startPosition = vehicleLandMovementController.transform.root.position;
      }
    }
    ...
    private void Start()
    {
      ...
      basePiecesController.LandMovementController = vehicleLandMovementController;
    ...
    public void FixedUpdate()
    {
      ...
      if (cameraTransform)
      {
        var wheelControllerTransform = vehicleLandMovementController.transform;
    ...
    {
      if (!_convexHullAPI || !vehicleLandMovementController) return;
      ...
      PhysicUtils.UpdateRelativeCenterOfMass(vehicleLandMovementController.vehicleRootBody, localCenterOfMassOffset);
    }
    ...
    private void Generate()
    {
      ...
      if (PiecesParentObj.transform.root.rotation != vehicleLandMovementController.transform.root.rotation)
      {
        ...
        PiecesParentObj.transform.root.rotation = vehicleLandMovementController.transform.root.rotation;
      }
      ...
      if (vehicleLandMovementController && convexHullParentGameObject != null)
      {
