...
{
  public class DragWindowControllerExtension : MonoBehaviour, IBeginDragHandler, IEventSystemHandler, IDragHandler
  {
    private RectTransform window;
    private Vector2 delta;
    public Action<RectTransform>? OnDragCalled = null;
