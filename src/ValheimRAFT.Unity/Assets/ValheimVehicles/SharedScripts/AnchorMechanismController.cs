...
namespace ValheimVehicles.SharedScripts
{
  ...
  public class AnchorMechanismController : ParentCollisionListener
  {
    ...
    private HoverFadeText hoverFadeText;
    ...
    internal void Awake()
    {
      ...
      hoverFadeText = anchorTextMeshProTransform.gameObject.AddComponent<HoverFadeText>();
    }
    ...
    {
      hoverFadeText.currentText = text == "" ? GetCurrentStateText() : text;
