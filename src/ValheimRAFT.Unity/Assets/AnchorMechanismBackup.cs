...
public class AnchorMechanismBackup : MonoBehaviour
{
    ...
    public HingeJoint rotatingAnchorCog;                 // Hinge joint for anchor movement
    ...
    void Start()
    {
        ...
        anchorJoint = anchorTransform.GetComponent<HingeJoint>();
    ...
    void Update()
    {
        ...
        switch (currentState)
        {
            case AnchorState.Dropping:
                DropAnchor();
                rotatingAnchorCog.useMotor = true;
                break;
            ...
            case AnchorState.Idle:
                rotatingAnchorCog.useMotor = false;
                break;
        }
    ...
    private void SpawnChainLink()
    {
        ...
        {
            var currentHinge = chainLinks[i].GetComponent<HingeJoint>();
                currentHinge.connectedAnchor = Vector3.up * 2;
            // if (i == 0)
            // {
            //     // chainLinks[i].GetComponent<Rigidbody>();
            //     continue;
            // }
        }
        ...
        anchorJoint.connectedBody = newChainLink.GetComponent<Rigidbody>();
