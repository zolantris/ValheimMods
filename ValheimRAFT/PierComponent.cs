...
public class PierComponent : MonoBehaviour
{
  ...
  public void Awake()
  {
    ...
    if (ZNetView.m_forceDisableInit)
    {
      ...
      Collider[] colliders =
        m_segmentObject.GetComponentsInChildren<Collider>(includeInactive: true);
  ...
  private void UpdateSegments()
  {
    base.transform.position = new Vector3(base.transform.position.x,
      ZoneSystem.instance.m_waterLevel + m_baseOffset, base.transform.position.z);
    RaycastHit[] hits =
      Physics.RaycastAll(base.transform.position, Vector3.down, 100f, m_terrainLayer);
    ...
    {
      GameObject segmentObj = Object.Instantiate(m_segmentObject, base.transform.position,
