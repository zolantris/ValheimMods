...
namespace ValheimRAFT
{
  public class SailComponent : MonoBehaviour, Interactable, Hoverable
  {
    ...
    public void Update()
    {
      ...
      this.m_sailCloth.randomAcceleration = Vector3.op_Multiply(Vector3.op_Multiply(windForce, this.m_windMultiplier), this.m_clothRandomAccelerationFactor);
    }
    ...
    public void SetAllowSailShrinking(bool allow)
    {
      if (!Object.op_Implicit((Object) this.m_mastComponent))
        return;
      this.m_sailFlags = allow ? this.m_sailFlags | SailComponent.SailFlags.AllowSailShrinking : this.m_sailFlags & ~SailComponent.SailFlags.AllowSailShrinking;
    ...
    public void SetDisableCloth(bool allow)
    {
      if (!Object.op_Implicit((Object) this.m_mastComponent))
        return;
      this.m_sailFlags = allow ? this.m_sailFlags | SailComponent.SailFlags.DisableCloth : this.m_sailFlags & ~SailComponent.SailFlags.DisableCloth;
    ...
    public void LoadFromMaterial()
    {
      ...
      if (CustomTextureGroup.Get("Sails").GetTextureByHash(StringExtensionMethods.GetStableHashCode(((Object) texture1).name)) != null)
      ...
      if (CustomTextureGroup.Get("Patterns").GetTextureByHash(StringExtensionMethods.GetStableHashCode(((Object) texture2).name)) != null)
      ...
      if (CustomTextureGroup.Get("Logos").GetTextureByHash(StringExtensionMethods.GetStableHashCode(((Object) texture3).name)) != null)
    ...
    public void LoadZDO()
    {
      ...
      SailComponent.SailLockedSide sailLockedSide1 = (SailComponent.SailLockedSide) reader.ReadByte();
      SailComponent.SailLockedSide sailLockedSide2 = (SailComponent.SailLockedSide) reader.ReadByte();
      ...
      this.SetAllowSailShrinking(sailFlags.HasFlag((Enum) SailComponent.SailFlags.AllowSailShrinking));
    ...
    {
      ZLog.Log((object) string.Format("CreateSailMesh(): {0} m_lockedSailCorners: {1} ({2}) m_lockedSailSides: {3} ({4})", (object) this.m_sailCorners.Count, (object) this.m_lockedSailCorners, (object) (int) this.m_lockedSailCorners, (object) this.m_lockedSailSides, (object) (int) this.m_lockedSailSides));
      ...
      else if (this.m_sailCorners.Count == 4)
      {
        ...
        for (int index1 = 0; (double) index1 <= (double) num1; ++index1)
        {
          ...
          {
            Vector3 vector3_3 = Vector3.Lerp(Vector3.Lerp(this.m_sailCorners[0], this.m_sailCorners[1], (float) index1 / num1), Vector3.Lerp(this.m_sailCorners[3], this.m_sailCorners[2], (float) index1 / num1), (float) index2 / num2);
    ...
    {
      this.m_sailCloth.enabled = !this.m_sailFlags.HasFlag((Enum) SailComponent.SailFlags.DisableCloth);
      Mesh sharedMesh = this.m_mesh.sharedMesh;
      ClothSkinningCoefficient[] skinningCoefficientArray = sharedMesh.vertexCount == this.m_sailCloth.coefficients.Length ? this.m_sailCloth.coefficients : new ClothSkinningCoefficient[sharedMesh.vertexCount];
      ...
      if (this.m_sailCorners.Count == 3)
      {
        ...
        if (this.m_lockedSailCorners == SailComponent.SailLockedSide.None && this.m_lockedSailSides == SailComponent.SailLockedSide.None)
        {
        ...
        for (int index = 0; index < sharedMesh.vertices.Length; ++index)
        {
          ...
          if (this.m_lockedSailCorners.HasFlag((Enum) SailComponent.SailLockedSide.B) && Vector3.op_Equality(sharedMesh.vertices[index], this.m_sailCorners[1]))
            skinningCoefficientArray[index].maxDistance = 0.0f;
          if (this.m_lockedSailCorners.HasFlag((Enum) SailComponent.SailLockedSide.C) && Vector3.op_Equality(sharedMesh.vertices[index], this.m_sailCorners[2]))
            skinningCoefficientArray[index].maxDistance = 0.0f;
          int num1;
      ...
      else if (this.m_sailCorners.Count == 4)
      {
        ...
        for (int index = 0; index < sharedMesh.vertices.Length; ++index)
        {
          ...
          if (this.m_lockedSailCorners.HasFlag((Enum) SailComponent.SailLockedSide.C) && Vector3.op_Equality(sharedMesh.vertices[index], this.m_sailCorners[2]))
            skinningCoefficientArray[index].maxDistance = 0.0f;
          if (this.m_lockedSailCorners.HasFlag((Enum) SailComponent.SailLockedSide.D) && Vector3.op_Equality(sharedMesh.vertices[index], this.m_sailCorners[3]))
            skinningCoefficientArray[index].maxDistance = 0.0f;
          int num4;
          if (this.m_lockedSailSides.HasFlag((Enum) SailComponent.SailLockedSide.A))
          {
    ...
    public void SetPattern(int hash)
    {
      ...
      CustomTextureGroup.CustomTexture textureByHash = CustomTextureGroup.Get("Patterns").GetTextureByHash(hash);
      if (textureByHash == null || !Object.op_Implicit((Object) textureByHash.Texture) || !Object.op_Implicit((Object) this.m_mesh))
        return;
    ...
    public void SetMain(int hash)
    {
      ...
      CustomTextureGroup.CustomTexture textureByHash = CustomTextureGroup.Get("Sails").GetTextureByHash(hash);
      if (textureByHash == null || !Object.op_Implicit((Object) textureByHash.Texture) || !Object.op_Implicit((Object) this.m_mesh))
        return;
    ...
    public void SetLogo(int hash)
    {
      ...
      CustomTextureGroup.CustomTexture textureByHash = CustomTextureGroup.Get("Logos").GetTextureByHash(hash);
      if (textureByHash == null || !Object.op_Implicit((Object) textureByHash.Texture) || !Object.op_Implicit((Object) this.m_mesh))
        return;
    ...
    {
      for (int index = 0; index < this.m_sailCorners.Count; ++index)
        Gizmos.DrawSphere(Vector3.op_Addition(((Component) this).transform.position, this.m_sailCorners[index]), 0.1f);
    }

    public string GetHoverName() => "";

    public string GetHoverText() => Localization.instance.Localize("[<color=yellow><b>$KEY_Use</b></color>] $mb_sail_edit");
