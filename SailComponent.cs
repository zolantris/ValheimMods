...
public class SailComponent : MonoBehaviour, Interactable, Hoverable
{
  ...
  public void SetDisableCloth(bool allow)
  {
    if ((bool)m_mastComponent)
    {
      ...
      if ((bool)(UnityEngine.Object)(object)m_sailCloth && m_sailCloth.enabled != !allow)
      {
  ...
  public void UpdateCoefficients()
  {
    ...
    ClothSkinningCoefficient[] coefficients =
      (ClothSkinningCoefficient[])((mesh.vertexCount == m_sailCloth.coefficients.Length)
        ? ((Array)m_sailCloth.coefficients)
        : ((Array)new ClothSkinningCoefficient[mesh.vertexCount]));
