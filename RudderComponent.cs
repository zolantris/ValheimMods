...
namespace ValheimRAFT
{
  public class RudderComponent : MonoBehaviour
  {
    ...
    public void UpdateIK(Animator animator)
    {
      ...
      float num3 = Mathf.Sin(num1 * 3.14159274f) * (1f - this.m_holdWheelTime) + this.m_holdWheelTime;
      float num4 = Mathf.Sin(num2 * 3.14159274f) * (1f - this.m_holdWheelTime) + this.m_holdWheelTime;
      if (Object.op_Implicit((Object) this.m_targetLeftHand) && (double) num1 > 0.99000000953674316)
      {
        this.m_currentLeftHand = this.m_targetLeftHand;
        this.m_targetLeftHand = (Transform) null;
      }
      if (Object.op_Implicit((Object) this.m_targetRightHand) && (double) num2 > 0.99000000953674316)
      {
