...
namespace ValheimRAFT
{
  ...
  public class ValheimRAFT : BaseUnityPlugin
  {
    ...
    internal void AddCustomPieces()
    {
      ...
      GameObject gameObject6 = ((Component)instance1.GetPrefab("Karve").transform.Find("ship/mast"))
        .gameObject;
      GameObject gameObject7 =
        ((Component)instance1.GetPrefab("VikingShip").transform.Find("ship/visual/Mast"))
        .gameObject;
      ...
      Destroy((Object)((Component)clonedPrefab1.transform.Find("ship/colliders/log")).gameObject);
      Destroy(
        (Object)((Component)clonedPrefab1.transform.Find("ship/colliders/log (1)")).gameObject);
      Destroy(
        (Object)((Component)clonedPrefab1.transform.Find("ship/colliders/log (2)")).gameObject);
      Destroy(
        (Object)((Component)clonedPrefab1.transform.Find("ship/colliders/log (3)")).gameObject);
      ...
      ropeLadderComponent.m_ropeLine =
        ((Component)ropeLadderComponent).GetComponent<LineRenderer>();
      ((Renderer)ropeLadderComponent.m_ropeLine).material =
        new Material(((Renderer)componentInChildren1).material);
      ropeLadderComponent.m_ropeLine.textureMode = (LineTextureMode)1;
      ropeLadderComponent.m_ropeLine.widthMultiplier = 0.05f;
      ropeLadderComponent.m_stepObject =
        ((Component)((Component)ropeLadderComponent).transform.Find("step")).gameObject;
      ((Renderer)ropeLadderComponent.m_stepObject.GetComponentInChildren<MeshRenderer>()).material =
        new Material(((Renderer)((Component)component2).GetComponentInChildren<MeshRenderer>())
          .material);
      ...
      ((Renderer)ropeAnchorComponent.m_rope).material =
        new Material(((Renderer)componentInChildren2).material);
      ...
      ((Component)emptyPrefab2.GetComponent<MeshRenderer>()).transform.localScale =
      ...
      ((Component)emptyPrefab3.GetComponent<MeshRenderer>()).transform.localScale =
        new Vector3(0.1f, 0.1f, 0.1f);
      ...
      Transform[] componentsInChildren1 =
      ...
      pierComponent2.m_segmentObject =
        instance1.CreateClonedPrefab("MBPier_Stone_Segment", prefab3);
      ...
      GameObject gameObject18 =
        ((Component)clonedPrefab10.transform.Find("Ramp/Segment/SegmentAnchor/Floor")).gameObject;
      GameObject gameObject19 = Object.Instantiate<GameObject>(
        ((Component)((Component)component2).transform.Find("New/_Combined Mesh [high]")).gameObject,
        gameObject18.transform.parent, false);
      ...
      Material sharedMaterial1 =
        ((Renderer)((Component)((Component)component1).transform.Find("New"))
          .GetComponent<MeshRenderer>()).sharedMaterial;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Winch1/Pole"))
        .GetComponent<MeshRenderer>()).sharedMaterial = sharedMaterial1;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Winch2/Pole"))
        .GetComponent<MeshRenderer>()).sharedMaterial = sharedMaterial1;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Ramp/Segment/SegmentAnchor/Pole1"))
        .GetComponent<MeshRenderer>()).sharedMaterial = sharedMaterial1;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Ramp/Segment/SegmentAnchor/Pole2"))
        .GetComponent<MeshRenderer>()).sharedMaterial = sharedMaterial1;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Winch1/Cylinder"))
        .GetComponent<MeshRenderer>()).sharedMaterial = sharedMaterial1;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Winch2/Cylinder"))
        .GetComponent<MeshRenderer>()).sharedMaterial = sharedMaterial1;
      Material sharedMaterial2 = ((Renderer)gameObject5.GetComponentInChildren<LineRenderer>(true))
        .sharedMaterial;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Rope1")).GetComponent<LineRenderer>())
        .sharedMaterial = sharedMaterial2;
      ((Renderer)((Component)clonedPrefab10.transform.Find("Rope2")).GetComponent<LineRenderer>())
        .sharedMaterial = sharedMaterial2;
      ...
      BoardingRampComponent boardingRampComponent =
        clonedPrefab10.AddComponent<BoardingRampComponent>();
